# building_energy_predictor:dev

[![pypi_status](https://img.shields.io/badge/BentoML-1.3.22-informational)](https://pypi.org/project/BentoML)
...
| ------------ | ----- | ------ |
| POST [`/predict`](#operations-Service_APIs-building_energy_predictor__predict) | JSON | JSON |
